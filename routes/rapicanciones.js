module.exports = function(app, gestorBD) {
    ...
    app.delete("/api/cancion/:id", function(req, res) {
        ...
        usuarioEsAutorCancion(usuario, cancion_id, function(esAutor) {
            if(esAutor){
    ...
    app.put("/api/cancion/:id", function(req, res) {
        ...
        validaDatosActualizarCancion(cancion, function(errors){
            if(errors !== null && errors.length > 0){
                ...
                let cancion_id = gestorBD.mongo.ObjectID(req.params.id);
                let errors = new Array();
                usuarioEsAutorCancion(cancion.autor, cancion_id, function (esAutor) {
                    if (esAutor) {
                        let criterio = {"_id": gestorBD.mongo.ObjectID(req.params.id)};
    ...
    function validaDatosCrearCancion(cancion, funcionCallback){
        let errors = new Array();
        if(cancion.nombre === null || typeof cancion.nombre === "undefined" || cancion.nombre === "" || cancion.nombre.length < 40){
